            ...
            <table class="w-full text-left border-collapse">
                <thead class="bg-gray-50 text-gray-600 text-sm border-b border-gray-100">
                    <tr>
                        ...
                        <th class="px-6 py-5 font-semibold">Rincian Solusi (Berdasarkan Umur / HST)</th>
                    ...
                    @forelse($deficiencies as $data)
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4 text-gray-600">
                                <div class="space-y-3">
                                    <div>
                                        <span class="inline-block px-2 py-1 bg-gray-100 text-gray-700 text-xs font-bold rounded-md mb-1">Solusi Umum</span>
                ...
                <form id="editForm" method="POST">
                    ...
                    <div class="bg-white px-6 pt-6 pb-6 sm:p-8 sm:pb-6">
                        <div class="flex items-center justify-between mb-5">
                            <h3 class="text-xl leading-6 font-bold text-gray-900">Edit Data Master & Solusi Penanganan</h3>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Solusi Umum <span class="text-red-500">*</span></label>
                                <textarea name="solution" id="edit_solution" rows="4" required class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500 shadow-sm text-sm" placeholder="Solusi umum jika umur HST tidak diketahui..."></textarea>
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Fase Vegetatif (0-40 HST)</label>
                                <textarea name="solution_vegetative" id="edit_vegetative" rows="4" class="w-full px-4 py-3 rounded-xl border border-green-200 focus:outline-none focus:ring-2 focus:ring-green-500 shadow-sm text-sm" placeholder="Solusi untuk umur 0-40 hari..."></textarea>
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Fase Generatif (41-60 HST)</label>
                                <textarea name="solution_generative" id="edit_generative" rows="4" class="w-full px-4 py-3 rounded-xl border border-yellow-200 focus:outline-none focus:ring-2 focus:ring-yellow-500 shadow-sm text-sm" placeholder="Solusi untuk umur 41-60 hari..."></textarea>
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Fase Pemasakan (>60 HST)</label>
                                <textarea name="solution_ripening" id="edit_ripening" rows="4" class="w-full px-4 py-3 rounded-xl border border-orange-200 focus:outline-none focus:ring-2 focus:ring-orange-500 shadow-sm text-sm" placeholder="Solusi untuk umur di atas 60 hari..."></textarea>
                            </div>
                        </div>
                    </div>
