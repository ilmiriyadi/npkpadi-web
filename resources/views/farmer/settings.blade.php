@extends('layouts.farmer') <!-- Ganti jadi layouts.admin untuk file Admin -->
...
@section('content')
    <div class="max-w-3xl mx-auto bg-white rounded-3xl shadow-sm border border-gray-100 p-8">
        ...
        <form action="{{ route('farmer.settings.update') }}" method="POST"> <!-- Ganti route untuk Admin -->
            @csrf
            @method('PUT')
            ...
            <div class="mt-8 flex justify-end">
                <button type="submit" class="bg-[#387F39] hover:bg-green-800 text-white px-8 py-3 rounded-xl font-bold transition-colors shadow-sm">
                    Simpan
